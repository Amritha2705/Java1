...
System.out.println("enter real & imaginary part of 1st complex number:");
int real1=sc.nextInt();
int imaginary1=sc.nextInt();
Complex ip1=new Complex(real1,imaginary1);
System.out.println("1st complex  number:"+ip1.real+"+i"+ip1.imaginary);
System.out.println("enter real 7 imaginary part of 2nd complex number:");
int real2=sc.nextInt();
int imaginary2=sc.nextInt();
Complex ip2=new Complex(real2,imaginary2);
System.out.println("2st complex  number:"+ip2.real+"+i"+ip2.imaginary);
